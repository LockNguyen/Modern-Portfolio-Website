...
import { recentExperience } from "@/data";
  ...
  return (
    <section id="experience" className="py-20">
      <h1 className="heading">
        <span className="text-galaxy" data-text="Professional Experience">Professional Experience</span>
      </h1>

      <div className="mt-10 flex flex-wrap items-center justify-center gap-x-24 gap-y-8 p-4">
        {recentExperience.map(
          ({ id, des, iconLists, img, link, sourceCode, title }) => (
            ...
            >
              <PinContainer title="Visit" href={link}>
                ...
                <p className="mt-3 text-sm font-light lg:text-xl lg:font-normal">
                  {des}
                </p>
